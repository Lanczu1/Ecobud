...
// User Management
adminRoutes.get("/users", authentication_1.requireAdminAccess, adminController_1.AdminController.getUsers);
adminRoutes.post("/users/:userId/reset-knowledge", authentication_1.requireAdminAccess, adminController_1.AdminController.resetKnowledge);
...
// Dashboard Stats
adminRoutes.get("/stats", authentication_1.requireAdminAccess, adminController_1.AdminController.getDashboardStats);
// Submissions
