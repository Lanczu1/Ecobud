...
const moderationRoutes_1 = require("./routes/moderationRoutes");
...
app.use('/api/faqs', faqRoutes_1.faqRoutes);
...
app.use('/api/moderation', moderationRoutes_1.moderationRoutes);
