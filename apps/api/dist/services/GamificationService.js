...
class GamificationService {
    ...
    async markEventAttendance(adminId, eventId, registrationId) {
        return this.database.$transaction(async (tx) => {
            ...
            if (event.adminId !== adminId) {
                throw new errorResponder_1.HttpError(403, 'Only the event owner can mark attendance.');
            }
    ...
    resolveStreak(lastActionDate, actionDate, currentStreak, highestStreak) {
        if (!lastActionDate) {
