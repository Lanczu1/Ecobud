...
lessonRoutes.get('/', authentication_1.authenticateRequest, (0, errorResponder_1.errorBoundary)(async (req, res) => {
...
lessonRoutes.get('/:lessonId', authentication_1.authenticateRequest, (0, errorResponder_1.errorBoundary)(async (req, res) => {
...
lessonRoutes.post('/:lessonId/complete', authentication_1.authenticateRequest, (0, errorResponder_1.errorBoundary)(async (req, res) => {
