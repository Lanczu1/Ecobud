...
habitRoutes.get('/today', authentication_1.authenticateRequest, (0, errorResponder_1.errorBoundary)(async (req, res) => {
...
habitRoutes.post('/:habitId/check-in', authentication_1.authenticateRequest, (0, errorResponder_1.errorBoundary)(async (req, res) => {
