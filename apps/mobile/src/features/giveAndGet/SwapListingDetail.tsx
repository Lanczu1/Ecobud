        ...
        <View style={localStyles.content}>
          ...
          {isOwnListing && listing.approvalStatus && listing.approvalStatus !== 'approved' && (
            <View style={{
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: responsiveFontSize(13), fontWeight: '700', color: listing.approvalStatus === 'rejected' ? '#DC2626' : '#D97706' }}>
                  {listing.approvalStatus === 'rejected' ? 'Listing Rejected' : 'Pending Approval'}
                </Text>
                <Text style={{ fontSize: responsiveFontSize(11), color: listing.approvalStatus === 'rejected' ? '#991B1B' : '#92400E', marginTop: 2 }}>
